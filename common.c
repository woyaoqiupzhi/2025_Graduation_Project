...
#define USE_WIFI_TYPE  1/***1:ESP-01,2:ESP-01S**********/
/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
//用户配置区
...
const u8* wifiap_ssid="DC_Express";			//对外SSID号
...
void atk_8266_msg_show(u16 x,u16 y,u8 wanip)
{
	...
	Lcd_Clear(WHITE);
	POINT_COLOR=BLUE;     
	//Show_Str(10,30,128,16,"Config",12,0);
	Show_Str(10,30,128,16,"Config ESP ....",12,0);
	#if (USE_WIFI_TYPE==2)
	sprintf((char*)p,"AT+CWSAP=\"%s\",\"%s\",9,3,4,0",wifiap_ssid,wifiap_password);    //配置模块AP模式无线参数
	#elif (USE_WIFI_TYPE==1)
	sprintf((char*)p,"AT+CWSAP=\"%s\",\"%s\",9,3,4",wifiap_ssid,wifiap_password);    //配置模块AP模式无线参数	
	#endif
...
void atk_8266_test(void)
{
	...
	POINT_COLOR=RED;
	Lcd_Clear(WHITE);
	Show_Str_Mid(10,5,"ATK-ESP8266",16,128);
	Show_Str_Mid(10,30,"WIFI  Test",16,128);

	while(atk_8266_send_cmd("AT","OK",20))//检查WIFI模块是否在线
	{
		atk_8266_quit_trans();//退出透传
		atk_8266_send_cmd("AT+CIPMODE=0","OK",200);  //关闭透传模式	
		Show_Str(10,55,128,16,"NO Module!",16,0);
		delay_ms(800);
		LCD_Fill(10,55,128,55+16,WHITE);
		Show_Str(10,55,128,16,"Connect...",16,0); 
	} 
